...
> [!Tip]: instead of typing the path, type `cd ` (with a trailing space) and then drag the project folder into the terminal window — the full path is pasted automatically. Then press Enter. 
